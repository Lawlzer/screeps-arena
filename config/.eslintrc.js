...
module.exports = {
	overrides: [
		// TypeScript
		{
			...
			plugins: ['@typescript-eslint', 'simple-import-sort'], // eslint-plugin-simple-import-sort
			rules: {
				strict: 2,
				...
				// This fixes bugs with types that are removed post-build (as the file may no longer be imported)
		...
		// JavaScript
		{
			...
			// parser: '', // Default ESLint parser (for JS)
			extends: ['eslint:recommended'],
			plugins: ['simple-import-sort'], // eslint-plugin-simple-import-sort
			rules: {
				strict: 2,
